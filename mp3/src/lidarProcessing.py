...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        # Handle sensor at 4 diagonal direction
        # Getting sensor reading for front left
        filter_front_left = np.logical_and((x_points > 0), (y_points > 0))
        filter_front_left = np.logical_and(filter_front_left, (y_points > x_points - 0.1))
        filter_front_left = np.logical_and(filter_front_left, (y_points < x_points + 0.1))
        ...
        filter_rear_left = np.logical_and(filter_rear_left, (y_points > -x_points - 0.1))
        filter_rear_left = np.logical_and(filter_rear_left, (y_points > -x_points + 0.1))
        ...
        filter_front_right = np.logical_and(filter_front_right, (y_points > -x_points - 0.1))
        filter_front_right = np.logical_and(filter_front_right, (y_points > -x_points + 0.1))
        ...
        filter_rear_right = np.logical_and(filter_rear_right, (y_points > x_points - 0.1))
        filter_rear_right = np.logical_and(filter_rear_right, (y_points < x_points + 0.1))
