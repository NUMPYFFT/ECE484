...
def line_fit(binary_warped):
	...
	for window in range(nwindows):
		...
		good_left_idxs = ((nonzeroy >= win_y_low) & (nonzeroy < win_y_high) & (nonzerox >= win_x_left_low) & (nonzerox < win_x_left_high)).nonzero()[0]
		good_right_idxs = ((nonzeroy >= win_y_low) & (nonzeroy < win_y_high) & (nonzerox >= win_x_right_low) & (nonzerox < win_x_right_high)).nonzero()[0]

		####
		# Append these indices to the lists
		##TO DO
		left_lane_inds.append(good_left_idxs)
		right_lane_inds.append(good_right_idxs)
	...
	####
		...
		print("000000Unable to detect lanes")
		return None
